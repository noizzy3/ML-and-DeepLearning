...
class PreGAN(object):
    ...
    def build_model(self):
        ...
        self.real_labels = tf.placeholder(tf.float32,[F.batch_size,10])  # was d_labels
        ...
        self.fake_out, self.classify_out = self.discriminator(self.images, reuse=False)
        #self.D_, self.D_logits_, = self.discriminator(self.G_mean, reuse=True)
        self.fake_out_, self.classify_out_ = self.discriminator(self.G_mean, reuse=True) # fake_out and fake_out_ distinguished
    ...
    def discriminator(self, image, reuse=False):
        with tf.variable_scope('D'):
            ...
            if F.dataset == "lsun":
                ...
                h_classifier = linear(h2_classifier, 10, 'd_classifier')
